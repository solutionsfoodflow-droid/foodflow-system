        ...
        <div>
          ...
          <div style={{ marginTop: '1.5rem', display: 'flex', gap: '0.75rem' }}>
            ...
            <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
              ...
              {!allAnswered && <span style={{ fontSize: '0.75rem', color: '#ef4444', textAlign: 'center', marginTop: '0.4rem', fontWeight: 600 }}>Responda a todas as perguntas antes de enviar.</span>}
            </div>
          </div>
        </div>
      )}
