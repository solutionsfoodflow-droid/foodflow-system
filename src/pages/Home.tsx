    ...
    <div className="app-container home-v2-theme">
      <header className={`header ${isScrolled ? 'header-scrolled' : ''}`}>
        <div className="container header-container">
          ...
          <div className="header-actions">
            <Link to={CONFIG.urls.acessarSistema} className="btn btn-primary btn-acessar animate-pulse-soft">
      ...
      {mobileMenuOpen && (
        <div className="mobile-nav">
          ...
          <Link to={CONFIG.urls.acessarSistema} className="btn btn-primary" onClick={() => setMobileMenuOpen(false)}>
            {CONFIG.hero.primaryCta}
          </Link>
        </div>
      )}
      ...
      <footer id="contato" className="footer">
        <div className="container footer-grid">
          ...
          <div className="footer-links">
            ...
            <Link to={CONFIG.urls.acessarSistema} className="footer-acessar">Área do Sistema</Link>
          </div>
        </div>
